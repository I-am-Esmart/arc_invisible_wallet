...
function getButtonClasses(variant: NonNullable<ButtonProps["variant"]> = "primary") {
  const base =
    "inline-flex items-center justify-center rounded-xl px-4 py-2.5 text-sm font-semibold transition duration-200 ease-out focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-brand-100 disabled:cursor-not-allowed disabled:opacity-60 active:scale-[0.98]";
